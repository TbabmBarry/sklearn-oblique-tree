...
int cur_no_of_points; {
  ...
  double oblique_split(), axis_parallel_split(), cart_split(), bivariate_split();
...
double bivariate_split(cur_points, cur_no_of_points, cur_label)
POINT ** cur_points;
int cur_no_of_points;
char * cur_label; {
...
char * cur_label; {
  ...
  // Assign initial coeffs to best_coeff_array
...
int update_coefficients(cur_points, cur_no_of_points)
struct point ** cur_points;
int cur_no_of_points; {
  int i, j = 0;
